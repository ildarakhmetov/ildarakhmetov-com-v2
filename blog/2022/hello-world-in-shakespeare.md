...
title: Hello World in Shakespeare
date: 2022-01-22 14:00:00
description: The "Hello, World" program as if Shakespeare wrote it.
tags:
- post
- programming
...
Dramatic Personae (`Hamlet`, `Romeo`, `Juliet` and `Ophelia`) are integer variables.
...
Using `sum` and `difference` operators, you can get any integers:
...
[Source](https://esolangs.org/wiki/Shakespeare))