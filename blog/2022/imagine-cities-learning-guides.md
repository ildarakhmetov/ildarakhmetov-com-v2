...
title: Imagine Cities Learning Guides
date: 2022-08-09 14:00:00
description: A capacity building program where learning guides are created to help
  users make a change in the community.
tags:
- post
- cmput401
- winter2022
...
You can **feel** it when you approach such a team. It's not just a group of people working together. It's a separate entity working together.

<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        <img src="/assets/img/blog/2022/learning-guides.png" alt="Imagine Cities Learning Guides" class="img-fluid rounded z-depth-1" />
    </div>
</div>
<div class="caption">
...
I say that it can be "felt" when a team clicks. But is there a reliable indicator? Well, there is one. When I see that a team is clearly having fun together, I know that the magic happened, and the team now has the most important component for success.
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/pvOsOMB3cAk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>