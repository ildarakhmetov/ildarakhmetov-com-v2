...
title: My Syllabus' AI Policy
date: 2024-08-25 10:00:00
description: AI has its place in a project, so it's never a question of whether to
  use it but when to use it.
tags:
- post
- AI
- education
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        <img src="/assets/img/blog/2024/ai-syllabus-post-image.jpg" alt="AI-generated drawing of a young man in a library sitting next to a robot" class="img-fluid rounded z-depth-1" />
    </div>
</div>
<div class="caption">
    AI can help if used appropriately.
</div>
